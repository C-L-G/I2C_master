// *******************************************************************************************************
// **                                                                                                   **
// **   24AA01.v - Microchip 24AA01 1K-BIT I2C SERIAL EEPROM (VCC = +1.7V TO +5.5V)                     **
// **                                                                                                   **
// *******************************************************************************************************
// **                                                                                                   **
...
module M24AA01 (A0, A1, A2, WP, SDA, SCL, RESET);
...
// *******************************************************************************************************
   ...
   reg  [06:00]         StartAddress;                   // memory access starting address
   ...
   reg  [06:00]         RdPointer;                      // read address pointer

   reg                  WriteActive;                    // memory write cycle active

   reg  [07:00]         MemoryBlock [0:127];            // EEPROM data memory array
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(negedge SCL) begin
      if (CTRL_Rcvd & (BitCounter == 8)) begin
         if (RdWrBit == 0) begin
            StartAddress <= ShiftRegister[06:00];
            RdPointer    <= ShiftRegister[06:00];
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(negedge WriteActive) begin
      for (LoopIndex = 0; LoopIndex < WrCounter; LoopIndex = LoopIndex + 1) begin
         ...
         MemoryBlock[{StartAddress[06:03],PageAddress[02:00]}] = WrDataByte[LoopIndex[02:00]];
      end
   end
...
// -------------------------------------------------------------------------------------------------------
   ...
   assign RdDataByte = MemoryBlock[RdPointer[06:00]];
